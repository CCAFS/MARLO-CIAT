...
<div class="buttons"> 
  <div class="buttons-content">
    ...
    [#elseif canEdit]
      [#-- Edit Button --]
      <a href="[@s.url][@s.param name="outputID" value=outputID /][@s.param name="edit" value="true"/][/@s.url]" class="form-button button-edit"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> [@s.text name="form.buttons.edit" /]</a>
    [/#if]
  </div>
</div>
