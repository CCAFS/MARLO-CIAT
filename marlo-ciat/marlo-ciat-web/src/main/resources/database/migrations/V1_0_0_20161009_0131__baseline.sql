...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_center`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_center` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_center` (
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_area`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_area` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_area` (
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_program`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_program` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_program` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` TEXT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_impact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_impact` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_impact` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_topic`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_topic` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_topic` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`impact_outcome`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`impact_outcome` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`impact_outcome` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_outcomes_rimpact`
    ...
    REFERENCES `marlo_ciat_db`.`research_impact` (`id` ),
  CONSTRAINT `fk_outcomes_rtopic`
    FOREIGN KEY (`research_topic_id` )
    REFERENCES `marlo_ciat_db`.`research_topic` (`id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 48
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_milestones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_milestones` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_milestones` (
  ...
  CONSTRAINT `fk_milestones_outcome`
    ...
    REFERENCES `marlo_ciat_db`.`impact_outcome` (`id` ))
ENGINE = InnoDB
AUTO_INCREMENT = 99
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`all_types`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`all_types` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`all_types` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_objectives`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_objectives` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_objectives` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_objective_type`
    FOREIGN KEY (`type_id` )
    REFERENCES `marlo_ciat_db`.`all_types` (`id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`impact_output`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`impact_output` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`impact_output` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_leader`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_leader` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_leader` (
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`impact_objective`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`impact_objective` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`impact_objective` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_impact_objective_objective`
    ...
    REFERENCES `marlo_ciat_db`.`research_objectives` (`id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB, 
...
-- -----------------------------------------------------
-- Table `marlo_ciat_db`.`research_partner`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `marlo_ciat_db`.`research_partner` ;

CREATE  TABLE IF NOT EXISTS `marlo_ciat_db`.`research_partner` (
  `id` INT NOT NULL AUTO_INCREMENT ,
