...
import org.cgiar.ccafs.marlo.data.service.impl.CapacityDevelopmentService;
 ...
 */
@ImplementedBy(CapacityDevelopmentService.class)
public interface ICapacityDevelopmentService {
   ...
   *         or -1 is some error occurred.
   */
  public long saveCapacityDevelopment(CapacityDevelopment capacityDevelopment, String actionName, List<String> relationsName);
