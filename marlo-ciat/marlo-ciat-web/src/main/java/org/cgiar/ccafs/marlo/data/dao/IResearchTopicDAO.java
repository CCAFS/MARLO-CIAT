...
import org.cgiar.ccafs.marlo.data.dao.impl.ResearchTopicDAO;
...
@ImplementedBy(ResearchTopicDAO.class)
public interface IResearchTopicDAO {
   ...
   * 
   * @return a list from ResearchTopic null if no exist records
   */
