...
import org.cgiar.ccafs.marlo.data.service.ICrpClusterOfActivityService;
 ...
 */
public class CrpClusterOfActivityService implements ICrpClusterOfActivityService {
  ...
  @Inject
  public CrpClusterOfActivityService(CrpClusterOfActivityDAO crpClusterOfActivityDAO) {
