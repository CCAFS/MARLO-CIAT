...
import org.cgiar.ccafs.marlo.data.service.impl.ResearchObjectiveService;
 ...
 */
@ImplementedBy(ResearchObjectiveService.class)
public interface IResearchObjectiveService {
   ...
   * 
   * @return a list from ResearchObjective null if no exist records
   */
   ...
   * 
   * @param researchObjectiveID is the researchObjective identifier.
   * @return a ResearchObjective object.
   */
