...
import org.cgiar.ccafs.marlo.data.service.impl.DeliverableCrosscutingThemeService;
 ...
 */
@ImplementedBy(DeliverableCrosscutingThemeService.class)
public interface IDeliverableCrosscutingThemeService {
   ...
   * 
   * @return a list from DeliverableCrosscutingTheme null if no exist records
   */
   ...
   * 
   * @param deliverableCrosscutingThemeID is the deliverableCrosscutingTheme identifier.
   * @return a DeliverableCrosscutingTheme object.
   */
   ...
   * 
   * @param deliverableCrosscutingTheme - is the deliverableCrosscutingTheme object with the new information to be added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the deliverableCrosscutingTheme was
   *         updated
