...
import org.cgiar.ccafs.marlo.data.service.impl.ProjectOutputService;
 ...
 */
@ImplementedBy(ProjectOutputService.class)
public interface IProjectOutputService {
   ...
   * 
   * @return a list from ProjectOutput null if no exist records
   */
   ...
   * 
   * @param projectOutputID is the projectOutput identifier.
   * @return a ProjectOutput object.
   */
  public ProjectOutput getProjectOutputById(long projectOutputID);
   ...
   */
  public long saveProjectOutput(ProjectOutput projectOutput);
