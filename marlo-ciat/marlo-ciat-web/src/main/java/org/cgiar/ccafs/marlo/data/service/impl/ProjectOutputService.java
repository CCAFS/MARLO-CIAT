 ...
 */
public class ProjectOutputService implements IProjectOutputService {


  private IProjectOutputDAO projectOutputDAO;

  // Managers


  @Inject
  public ProjectOutputService(IProjectOutputDAO projectOutputDAO) {
