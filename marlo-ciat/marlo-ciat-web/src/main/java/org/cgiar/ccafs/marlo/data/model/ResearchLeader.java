 ...
 */
public class ResearchLeader implements java.io.Serializable, IAuditLog {
   ...
   * @param user
   */
  public ResearchLeader(ResearchArea researchArea, User user) {
    super();
   ...
   * @param user
   */
  public ResearchLeader(ResearchCenter researchCenter, User user) {
    super();
   ...
   * @param user
   */
  public ResearchLeader(ResearchProgram researchProgram, ResearchCenter researchCenter, ResearchArea researchArea,
    User user) {
    super();
   ...
   * @param user
   */
  public ResearchLeader(ResearchProgram researchProgram, User user) {
    super();
    this.researchProgram = researchProgram;
    this.user = user;
  }
  ...
  public boolean equals(Object obj) {
    ...
    ResearchLeader other = (ResearchLeader) obj;
    if (id == null) {
      if (other.id != null) {
        return false;
      }
