...
import org.cgiar.ccafs.marlo.data.service.impl.BeneficiaryService;
 ...
 */
@ImplementedBy(BeneficiaryService.class)
public interface IBeneficiaryService {
   ...
   * 
   * @return a list from Beneficiary null if no exist records
   */
