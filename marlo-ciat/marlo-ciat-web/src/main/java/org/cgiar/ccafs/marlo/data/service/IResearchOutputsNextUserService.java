...
import org.cgiar.ccafs.marlo.data.service.impl.ResearchOutputsNextUserService;
 ...
 */
@ImplementedBy(ResearchOutputsNextUserService.class)
public interface IResearchOutputsNextUserService {
   ...
   * 
   * @return a list from ResearchOutputsNextUser null if no exist records
   */
   ...
   * 
   * @param researchOutputsNextUserID is the researchOutputsNextUser identifier.
   * @return a ResearchOutputsNextUser object.
   */
