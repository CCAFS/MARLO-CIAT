...
import org.cgiar.ccafs.marlo.data.service.impl.ResearchOutputService;
 ...
 */
@ImplementedBy(ResearchOutputService.class)
public interface IResearchOutputService {
   ...
   * 
   * @return a list from ResearchOutput null if no exist records
   */
   ...
   * 
   * @param researchOutputID is the researchOutput identifier.
   * @return a ResearchOutput object.
   */
