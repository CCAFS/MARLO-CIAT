...
import org.cgiar.ccafs.marlo.data.service.impl.ProjectTypeService;
 ...
 */
@ImplementedBy(ProjectTypeService.class)
public interface IProjectTypeService {
   ...
   * 
   * @return a list from ProjectType null if no exist records
   */
