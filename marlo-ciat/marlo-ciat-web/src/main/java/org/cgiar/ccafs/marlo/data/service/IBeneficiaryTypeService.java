...
import org.cgiar.ccafs.marlo.data.service.impl.BeneficiaryTypeService;
 ...
 */
@ImplementedBy(BeneficiaryTypeService.class)
public interface IBeneficiaryTypeService {
   ...
   * 
   * @return a list from BeneficiaryType null if no exist records
   */
   ...
   * 
   * @param beneficiaryTypeID is the beneficiaryType identifier.
   * @return a BeneficiaryType object.
   */
