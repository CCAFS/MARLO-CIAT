...
import org.cgiar.ccafs.marlo.data.service.impl.MonitorignOutcomeEvidenceService;
 ...
 */
@ImplementedBy(MonitorignOutcomeEvidenceService.class)
public interface IMonitorignOutcomeEvidenceService {
   ...
   * 
   * @return a list from MonitorignOutcomeEvidence null if no exist records
   */
   ...
   * 
   * @param monitorignOutcomeEvidenceID is the monitorignOutcomeEvidence identifier.
   * @return a MonitorignOutcomeEvidence object.
   */
