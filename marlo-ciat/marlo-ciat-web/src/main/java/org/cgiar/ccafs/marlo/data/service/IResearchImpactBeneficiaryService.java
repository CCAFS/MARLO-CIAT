...
import org.cgiar.ccafs.marlo.data.service.impl.ResearchImpactBeneficiaryService;
 ...
 */
@ImplementedBy(ResearchImpactBeneficiaryService.class)
public interface IResearchImpactBeneficiaryService {
   ...
   * 
   * @return a list from ResearchImpactBeneficiary null if no exist records
   */
   ...
   * 
   * @param researchImpactBeneficiaryID is the researchImpactBeneficiary identifier.
   * @return a ResearchImpactBeneficiary object.
   */
   ...
   * 
   * @param researchImpactBeneficiary - is the researchImpactBeneficiary object with the new information to be added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the researchImpactBeneficiary was
   *         updated
