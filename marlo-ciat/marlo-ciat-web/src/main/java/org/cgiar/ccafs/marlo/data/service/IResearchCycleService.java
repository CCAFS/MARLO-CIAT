...
import org.cgiar.ccafs.marlo.data.service.impl.ResearchCycleService;
 ...
 */
@ImplementedBy(ResearchCycleService.class)
public interface IResearchCycleService {
   ...
   * 
   * @return a list from ResearchCycle null if no exist records
   */
