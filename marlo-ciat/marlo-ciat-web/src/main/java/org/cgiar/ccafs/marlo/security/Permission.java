...
public class Permission {
	...
	public static final String CRP_ADMIN_VISIBLE_PRIVILEGES = "crp:{0}:admin:canAcess"; // path
																						// full
																						// privileges
	public static final String CRP_ADMIN_EDIT_PRIVILEGES = "crp:{0}:admin:*"; // path
																				// full
																				// privileges
	...
	public static final String PROJECT_DELIVERABLE_LIST_ADD_PERMISSION = "crp:{0}:project:{1}:deliverablesList:addDeliverable";
	public static final String PROJECT_DELIVERABLE_LIST_REMOVE_PERMISSION = "crp:{0}:project:{1}:deliverablesList:removeOldDeliverables";
