...
import org.cgiar.ccafs.marlo.data.service.impl.FundingSourceTypeService;
 ...
 */
@ImplementedBy(FundingSourceTypeService.class)
public interface IFundingSourceTypeService {
   ...
   * 
   * @return a list from FundingSourceType null if no exist records
   */
   ...
   * 
   * @param fundingSourceTypeID is the fundingSourceType identifier.
   * @return a FundingSourceType object.
   */
  public FundingSourceType getFundingSourceTypeById(long fundingSourceTypeID);
   ...
   */
  public long saveFundingSourceType(FundingSourceType fundingSourceType);
