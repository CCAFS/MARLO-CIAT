...
import org.cgiar.ccafs.marlo.data.service.impl.CrpClusterKeyOutputOutcomeService;
 ...
 */
@ImplementedBy(CrpClusterKeyOutputOutcomeService.class)
public interface ICrpClusterKeyOutputOutcomeService {
   ...
   * 
   * @param crpClusterKeyOutputOutcome - is the crpClusterKeyOutputOutcome object with the new information to be
   *        added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the
   *         crpClusterKeyOutputOutcome was
   *         updated
