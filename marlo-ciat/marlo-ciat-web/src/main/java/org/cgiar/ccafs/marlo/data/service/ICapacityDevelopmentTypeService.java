...
import org.cgiar.ccafs.marlo.data.service.impl.CapacityDevelopmentTypeService;
...
public interface ICapacityDevelopmentTypeService {
   ...
   * 
   * @param capacityDevelopmentType - is the capacityDevelopmentType object with the new information to be added/updated.
   * @return a number greater than 0 representing the new ID assigned by the database, 0 if the capacityDevelopmentType was
   *         updated
   ...
   *         or -1 is some error occurred.
   */
  public long saveCapacityDevelopmentType(CapacityDevelopmentType capacityDevelopmentType, String actionName, List<String> relationsName);
