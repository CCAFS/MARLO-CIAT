...
import org.cgiar.ccafs.marlo.data.service.impl.ResearchRegionService;
 ...
 */
@ImplementedBy(ResearchRegionService.class)
public interface IResearchRegionService {
   ...
   * 
   * @return a list from ResearchRegion null if no exist records
   */
   ...
   * 
   * @param researchRegionID is the researchRegion identifier.
   * @return a ResearchRegion object.
   */
