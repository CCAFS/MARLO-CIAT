...
import org.cgiar.ccafs.marlo.data.service.impl.ResearchImpactService;
 ...
 */
@ImplementedBy(ResearchImpactService.class)
public interface IResearchImpactService {
   ...
   * 
   * @return a list from ResearchImpact null if no exist records
   */
   ...
   * 
   * @param researchImpactID is the researchImpact identifier.
   * @return a ResearchImpact object.
   */
