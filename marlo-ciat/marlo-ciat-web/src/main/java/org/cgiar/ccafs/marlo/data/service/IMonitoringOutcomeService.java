...
import org.cgiar.ccafs.marlo.data.service.impl.MonitoringOutcomeService;
 ...
 */
@ImplementedBy(MonitoringOutcomeService.class)
public interface IMonitoringOutcomeService {
   ...
   * 
   * @return a list from MonitoringOutcome null if no exist records
   */
   ...
   * 
   * @param monitoringOutcomeID is the monitoringOutcome identifier.
   * @return a MonitoringOutcome object.
   */
