 ...
 */
public class FundingSourceTypeService implements IFundingSourceTypeService {


  private IFundingSourceTypeDAO fundingSourceTypeDAO;

  // Managers


  @Inject
  public FundingSourceTypeService(IFundingSourceTypeDAO fundingSourceTypeDAO) {
