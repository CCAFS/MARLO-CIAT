...
import org.cgiar.ccafs.marlo.data.service.impl.DeliverableOutputService;
 ...
 */
@ImplementedBy(DeliverableOutputService.class)
public interface IDeliverableOutputService {
   ...
   * 
   * @return a list from DeliverableOutput null if no exist records
   */
   ...
   * 
   * @param deliverableOutputID is the deliverableOutput identifier.
   * @return a DeliverableOutput object.
   */
