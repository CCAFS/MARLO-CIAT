...
import org.cgiar.ccafs.marlo.data.service.impl.CrpClusterOfActivityService;
 ...
 */
@ImplementedBy(CrpClusterOfActivityService.class)
public interface ICrpClusterOfActivityService {
