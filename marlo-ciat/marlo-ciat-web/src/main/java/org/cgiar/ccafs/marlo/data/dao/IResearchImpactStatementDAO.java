...
import org.cgiar.ccafs.marlo.data.dao.impl.ResearchImpactStatementDAO;
...
@ImplementedBy(ResearchImpactStatementDAO.class)
public interface IResearchImpactStatementDAO {
