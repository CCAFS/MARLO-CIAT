...
import org.cgiar.ccafs.marlo.data.service.impl.ProjectCrosscutingThemeService;
 ...
 */
@ImplementedBy(ProjectCrosscutingThemeService.class)
public interface IProjectCrosscutingThemeService {
   ...
   * 
   * @return a list from ProjectCrosscutingTheme null if no exist records
   */
   ...
   * 
   * @param projectCrosscutingThemeID is the projectCrosscutingTheme identifier.
   * @return a ProjectCrosscutingTheme object.
   */
