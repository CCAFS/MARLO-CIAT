...
public class ProjectFundingSource implements java.io.Serializable, IAuditLog {
  ...
  public ProjectFundingSource(Long id, User modifiedBy, User createdBy, Crp crp, Project project, String title,
    FundingSourceType fundingSourceType, boolean active, Date activeSince, String modificationJustification) {
    super();
    this.id = id;
