...
import org.cgiar.ccafs.marlo.data.service.impl.MonitoringMilestoneService;
 ...
 */
@ImplementedBy(MonitoringMilestoneService.class)
public interface IMonitoringMilestoneService {
   ...
   * 
   * @return a list from MonitoringMilestone null if no exist records
   */
   ...
   * 
   * @param monitoringMilestoneID is the monitoringMilestone identifier.
   * @return a MonitoringMilestone object.
   */
