...
import org.cgiar.ccafs.marlo.data.service.impl.ProjectStatusService;
 ...
 */
@ImplementedBy(ProjectStatusService.class)
public interface IProjectStatusService {
   ...
   * 
   * @return a list from ProjectStatus null if no exist records
   */
